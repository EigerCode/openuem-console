...
func (h *Handler) Register(e *echo.Echo) {
	...
	e.GET("/admin/nanohub", h.NanoHubSettings, h.IsAuthenticated, h.MainTenantAdminMiddleware)
	e.POST("/admin/nanohub", h.SaveNanoHubSettings, h.IsAuthenticated, h.MainTenantAdminMiddleware)
	e.DELETE("/admin/nanohub", h.DeleteNanoHubSettings, h.IsAuthenticated, h.MainTenantAdminMiddleware)
	e.POST("/admin/nanohub/vendor", h.UploadVendorCert, h.IsAuthenticated, h.MainTenantAdminMiddleware)
	e.DELETE("/admin/nanohub/vendor", h.DeleteVendorCert, h.IsAuthenticated, h.MainTenantAdminMiddleware)
	...
	e.GET("/tenant/:tenant/admin/nanohub", h.NanoHubPushCertPage, h.IsAuthenticated, h.TenantAdminMiddleware)
	e.POST("/tenant/:tenant/admin/nanohub/csr", h.GenerateNanoHubCSR, h.IsAuthenticated, h.TenantAdminMiddleware)
	e.POST("/tenant/:tenant/admin/nanohub/sign", h.SignAndDownloadPushRequest, h.IsAuthenticated, h.TenantAdminMiddleware)
	e.POST("/tenant/:tenant/admin/nanohub/pushcert", h.UploadNanoHubPushCert, h.IsAuthenticated, h.TenantAdminMiddleware)
	e.POST("/tenant/:tenant/admin/nanohub/renew", h.RenewNanoHubCSR, h.IsAuthenticated, h.TenantAdminMiddleware)
	e.GET("/tenant/:tenant/admin/enrollment/:id/mdmprofile", h.DownloadMDMProfile, h.IsAuthenticated, h.TenantAdminMiddleware)
	...
	e.POST("/computers/:uuid/power/nanohuboff", h.NanoHubPowerOff, h.IsAuthenticated)
	e.POST("/computers/:uuid/power/nanohubreboot", h.NanoHubReboot, h.IsAuthenticated)
	...
	e.POST("/tenant/:tenant/computers/:uuid/power/nanohuboff", h.NanoHubPowerOff, h.IsAuthenticated)
	e.POST("/tenant/:tenant/computers/:uuid/power/nanohubreboot", h.NanoHubReboot, h.IsAuthenticated)
	...
	e.POST("/tenant/:tenant/site/:site/computers/:uuid/power/nanohuboff", h.NanoHubPowerOff, h.IsAuthenticated)
	e.POST("/tenant/:tenant/site/:site/computers/:uuid/power/nanohubreboot", h.NanoHubReboot, h.IsAuthenticated)
	...
	e.GET("/api/enroll/:token/mdmprofile", h.PublicDownloadMDMProfile)
