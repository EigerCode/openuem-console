...
func (h *Handler) Register(e *echo.Echo) {
	...
	// Global Admin routes - only Hoster Tenant Admins
	e.GET("/admin", func(c echo.Context) error { return h.ListTenants(c, "", "", false) }, h.IsAuthenticated, h.SuperAdminMiddleware)
	e.POST("/admin", func(c echo.Context) error { return h.ListTenants(c, "", "", false) }, h.IsAuthenticated, h.SuperAdminMiddleware)
	e.GET("/admin/tenants", func(c echo.Context) error { return h.ListTenants(c, "", "", false) }, h.IsAuthenticated, h.SuperAdminMiddleware)
	e.POST("/admin/tenants", func(c echo.Context) error { return h.ListTenants(c, "", "", false) }, h.IsAuthenticated, h.SuperAdminMiddleware)

	// Global User Management - only Hoster Admins (user CRUD)
	e.GET("/admin/users", func(c echo.Context) error { return h.ListUsers(c, "", "") }, h.IsAuthenticated, h.SuperAdminMiddleware)
	e.POST("/admin/users", func(c echo.Context) error { return h.ListUsers(c, "", "") }, h.IsAuthenticated, h.SuperAdminMiddleware)
	e.GET("/admin/users/new", h.NewUser, h.IsAuthenticated, h.SuperAdminMiddleware)
	e.POST("/admin/users/new", h.AddUser, h.IsAuthenticated, h.SuperAdminMiddleware)
	e.POST("/admin/users/import", h.ImportUsers, h.IsAuthenticated, h.SuperAdminMiddleware)
	e.POST("/admin/users/:uid/certificate", h.RequestUserCertificate, h.IsAuthenticated, h.SuperAdminMiddleware)
	e.POST("/admin/users/:uid/renewcertificate", h.RenewUserCertificate, h.IsAuthenticated, h.SuperAdminMiddleware)
	e.POST("/admin/users/:uid/askconfirm", h.AskForConfirmation, h.IsAuthenticated, h.SuperAdminMiddleware)
	e.POST("/admin/users/:uid/confirmemail", h.SetEmailConfirmed, h.IsAuthenticated, h.SuperAdminMiddleware)
	e.POST("/admin/users/:uid/approve", h.ApproveAccount, h.IsAuthenticated, h.SuperAdminMiddleware)
	e.POST("/admin/users/:uid/resendpasslink", h.ResendPasswordLink, h.IsAuthenticated, h.SuperAdminMiddleware)
	e.DELETE("/admin/users/:uid", h.DeleteUser, h.IsAuthenticated, h.SuperAdminMiddleware)

	// Tenant management routes - only SuperAdmins
	e.GET("/admin/tenants/new", h.NewTenant, h.IsAuthenticated, h.SuperAdminMiddleware)
	e.POST("/admin/tenants/new", h.AddTenant, h.IsAuthenticated, h.SuperAdminMiddleware)
	e.POST("/admin/tenants/import", h.ImportTenants, h.IsAuthenticated, h.SuperAdminMiddleware)
	e.GET("/admin/tenants/:tenant", h.EditTenant, h.IsAuthenticated, h.SuperAdminMiddleware)
	e.POST("/admin/tenants/:tenant", h.EditTenant, h.IsAuthenticated, h.SuperAdminMiddleware)
	e.GET("/admin/tenants/:tenant/confirm-delete", func(c echo.Context) error { return h.ListTenants(c, "", "", true) }, h.IsAuthenticated, h.SuperAdminMiddleware)
	e.DELETE("/admin/tenants/:tenant", h.DeleteTenant, h.IsAuthenticated, h.SuperAdminMiddleware)

	// Global Settings routes - only SuperAdmins
	e.GET("/admin/sessions", func(c echo.Context) error { successMessage := ""; return h.ListSessions(c, successMessage) }, h.IsAuthenticated, h.SuperAdminMiddleware)
	e.GET("/admin/sessions/:token/delete", h.SessionDelete)
	e.DELETE("/admin/sessions/:token", h.SessionConfirmDelete, h.IsAuthenticated, h.SuperAdminMiddleware)
	e.GET("/admin/smtp", h.SMTPSettings, h.IsAuthenticated, h.SuperAdminMiddleware)
	e.POST("/admin/smtp", h.SMTPSettings, h.IsAuthenticated, h.SuperAdminMiddleware)
	e.POST("/admin/smtp/test", h.TestSMTPSettings, h.IsAuthenticated, h.SuperAdminMiddleware)
	e.GET("/admin/settings", h.GeneralSettings, h.IsAuthenticated, h.SuperAdminMiddleware)
	e.POST("/admin/settings", h.GeneralSettings, h.IsAuthenticated, h.SuperAdminMiddleware)
	e.GET("/admin/branding", h.GetBrandingSettings, h.IsAuthenticated, h.SuperAdminMiddleware)
	e.POST("/admin/branding/logo", h.PostBrandingLogo, h.IsAuthenticated, h.SuperAdminMiddleware)
	e.DELETE("/admin/branding/logo", h.DeleteBrandingLogo, h.IsAuthenticated, h.SuperAdminMiddleware)
	e.POST("/admin/branding/favicon", h.PostBrandingFavicon, h.IsAuthenticated, h.SuperAdminMiddleware)
	e.DELETE("/admin/branding/favicon", h.DeleteBrandingFavicon, h.IsAuthenticated, h.SuperAdminMiddleware)
	e.POST("/admin/branding/product-name", h.PostBrandingProductName, h.IsAuthenticated, h.SuperAdminMiddleware)
	e.POST("/admin/branding/colors", h.PostBrandingColors, h.IsAuthenticated, h.SuperAdminMiddleware)
	e.POST("/admin/branding/login", h.PostBrandingLogin, h.IsAuthenticated, h.SuperAdminMiddleware)
	e.POST("/admin/branding/login-background", h.PostBrandingLoginBackground, h.IsAuthenticated, h.SuperAdminMiddleware)
	e.DELETE("/admin/branding/login-background", h.DeleteBrandingLoginBackground, h.IsAuthenticated, h.SuperAdminMiddleware)
	e.GET("/admin/certificates", h.ListCertificates, h.IsAuthenticated, h.SuperAdminMiddleware)
	e.POST("/admin/certificates", h.CertificateConfirmRevocation, h.IsAuthenticated, h.SuperAdminMiddleware)
	e.DELETE("/admin/certificates", h.RevocateCertificate, h.IsAuthenticated, h.SuperAdminMiddleware)
	e.GET("/admin/authentication", h.AuthenticationSettings, h.IsAuthenticated, h.SuperAdminMiddleware)
	e.POST("/admin/authentication", h.AuthenticationSettings, h.IsAuthenticated, h.SuperAdminMiddleware)
	e.GET("/admin/update-servers", h.UpdateServers, h.IsAuthenticated, h.SuperAdminMiddleware)
	e.POST("/admin/update-servers", h.UpdateServers, h.IsAuthenticated, h.SuperAdminMiddleware)
	e.DELETE("/admin/update-servers/:serverId", h.UpdateServers, h.IsAuthenticated, h.SuperAdminMiddleware)
	e.POST("/admin/update-servers/confirm", h.UpdateServersConfirm, h.IsAuthenticated, h.SuperAdminMiddleware)
	e.POST("/admin/confirm-delete-server/:serverId", h.DeleteServerConfirm, h.IsAuthenticated, h.SuperAdminMiddleware)
	e.GET("/admin/rustdesk", h.RustDeskSettings, h.IsAuthenticated, h.SuperAdminMiddleware)
	e.POST("/admin/rustdesk", h.RustDeskSettings, h.IsAuthenticated, h.SuperAdminMiddleware)
